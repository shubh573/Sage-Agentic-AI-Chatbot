...
from sentry_sdk.integrations.google_genai import streaming
...
Rules:
- If the user asks about latest news, current events, recent updated, today's information, current price, current weather report, current stock price.
...
def build_agent(model_name: str):
    """
    Build one LangGraph agent for a selected LLM model.
    """
...
def get_agent(model_name: str | None = None):
    """
    Return cached LangGraph agent for selected LLM model.
